 ...
 * Generated at: 2017-04-25 03:48:02 UTC
...
request.setAttribute("ctx",request.getContextPath()) ;
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"inputAccount\" placeholder=\"vip名\" onblur = \"vipAddCommond.findV()\" onfocus=\"true\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label\" id = \"tip\"></label>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputName\">姓&nbsp;&nbsp;&nbsp;名 :</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"inputName\" placeholder=\"姓名\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputUseMoney\"> 已用金额:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"inputUseMoney\" placeholder=\"已用金额\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputCode\">积分 :</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"inputCode\" placeholder=\"积分\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label\" for=\"inputDate\">日期 :</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"datetime\" id=\"inputDate\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn col-sm-offset-4 col-sm-4\" onclick = \"vipAddCommond.addvip()\">增加vip</button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("<script type = \"text/javascript\" src = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/js/vip/addVip.js\" ></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
