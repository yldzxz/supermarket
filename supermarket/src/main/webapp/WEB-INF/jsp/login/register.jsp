...
<body onload = "find(1);">
	<div class = "container-fluid">
		...
		<div class = "container-fluid my-show-box">
				<div class = "col-sm-12 col-xs-12 my-show-box-header" ><h3 class = "text-center" ><strong>注册管理员<strong></h3></div>
				
				<div class = "row">
					
					<div class = "col-sm-offset-4 col-sm-6 register-box ">
								
							<div class = "col-sm-12 register-input">
								<div class= "col-sm-2">用户昵称:</div><input type = "text" class = "col-sm-5 "id= "username" />
							...
							<div class = "col-sm-12 register-input text-center">
								<button class = "col-sm-offset-1 col-sm-6 submit-button text-center" style="background-color:#73B0E4;" onclick = "check();">注册</button> 
							</div>
