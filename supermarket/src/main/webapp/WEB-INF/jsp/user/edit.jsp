				...
				<div class = "col-sm-12">
					<form class="form-horizontal text-center" >
						<div class="control-group">
							...
							<input type="text" id="inputId" placeholder="id" readonly value = "${user.userId}">
						</div>					
						<div class="control-group">
							<label class="control-label" for="inputUsername">用户名 :</label>
							<input type="text" id="inputUsername" placeholder="用户名" value = "${user.userAccount}" readonly>
						</div>
						<br/>
						<div class="control-group">
							<label class="control-label" for="inputPassword">密  &nbsp;&nbsp;&nbsp;码 :</label>
							<input type="password" id="inputPassword" placeholder="密码" value = "${user.userPassword}">
						</div>
						<br/>
						<div class="control-group">
							<label class="control-label" for="inputEmail">邮  &nbsp;&nbsp;&nbsp;件 :</label>
							<input type="email" id="inputEmail" placeholder="邮件" value = "${user.userEmail}">
						</div>
						<br/>
						<div class="control-group">
							<label class="control-label" for="inputAge">年  &nbsp;&nbsp;&nbsp;龄 :</label>
							<input type="text" id="inputAge" placeholder="年龄" value = "${user.userAge}" >
						</div>
						<br/>
						<div class="control-group">
							<label class="control-label" for="inputSarl">薪  &nbsp;&nbsp;&nbsp;资 :</label>
							<input type="text" id="inputSarl" placeholder="薪资" value = "${user.userSalary}">
						</div>
						<br/>
						<div class="control-group">
						...
						<div class="control-group">
								...
								<button type="button" class="btn col-sm-offset-4 col-sm-4" onclick = "userEditCommond.editUser()">编辑用户</button>
